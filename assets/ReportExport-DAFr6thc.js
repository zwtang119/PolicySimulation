import{u as N,r as o,j as e,B as v}from"./index-Z-66XPae.js";import{C as k}from"./Card-DGiMDde0.js";const E=()=>{const{reports:i}=N(),[a,r]=o.useState([]),[d,m]=o.useState(!1),[l,x]=o.useState("md"),p=s=>{a.includes(s)?r(a.filter(t=>t!==s)):r([...a,s])},h=()=>{a.length===i.length?r([]):r(i.map(s=>s.id))},g=s=>{const t=s.content;return`
# ${s.title}
**日期**: ${s.date}
