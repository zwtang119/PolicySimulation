import{A as s,r as w,j as e,S as A}from"./index-m148XmJS.js";import{M as b}from"./MarkdownRenderer-9506r3Kb.js";const k=({status:n})=>{const r={[s.PolicyParsing]:"正在解析政策文件...",[s.DnaLoading]:"正在加载企业数字画像...",[s.Simulating_RunningTurns]:"多智能体博弈推演中...",[s.Simulating_Aggregation]:"正在汇总博弈数据...",[s.Simulating_SynthesizingReport]:"正在撰写最终评估报告..."};return r[n]?e.jsxs("div",{className:"flex flex-col items-center justify-center h-full text-center",children:[e.jsx(A,{size:"lg"}),e.jsx("p",{className:"mt-4 text-lg text-gray-500 animate-pulse",children:r[n]})]}):e.jsx("p",{className:"mt-4 text-lg text-gray-500",children:"处理中..."})},R=({report:n,status:r,error:x,companies:u})=>{const h=[s.PolicyParsing,s.DnaLoading,s.Simulating_RunningTurns,s.Simulating_Aggregation,s.Simulating_SynthesizingReport].includes(r),p=w.useMemo(()=>{if(!n)return"";const c=n.executiveSummary||"暂无摘要",a=n.policyEffectiveness||{alignment:"",impactStrength:"",deviations:""},m=`
### 2.1 目标对齐度
${a.alignment||"N/A"}
