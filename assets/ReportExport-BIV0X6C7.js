import{u as v,r as x,j as t,B as k}from"./index-DQro5Ze1.js";import{C as N}from"./Card-Dv1oaerZ.js";const S=()=>{const{reports:c}=v(),[i,d]=x.useState([]),[u,p]=x.useState(!1),[l,$]=x.useState("md"),y=a=>{i.includes(a)?d(i.filter(e=>e!==a)):d([...i,a])},g=()=>{i.length===c.length?d([]):d(c.map(a=>a.id))},f=a=>{const e=a.content;let r="";e.executiveSummary&&(r=`### 总体评价：${e.executiveSummary.verdict}
